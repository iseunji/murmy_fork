...
socket.on('game-start', async (data) => {
  ...
  const introText =
    '(하진이 읽어주세요) S 대학교 인공지능학과 자율시스템 연구실. 국내 최상위 AI 연구 그룹으로, 최근 \'실제 인간 수준의 가치판단과 자율성을 가진 AI 시스템\' 연구로 학계 안팎의 큰 주목을 받고 있다. 그 연구의 중심에는 ARIA가 있다. 연구실이 자체 개발한 자율 추론 인공지능. 로봇 팔과 연결되어 물리적 세계에도 개입할 수 있는, embodied AI 시스템이다.'
    + '\n\n'
